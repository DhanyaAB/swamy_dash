...
export class NavbarComponent implements OnInit {
  ...
  constructor(private http: HttpClient, private appService: AppService, private router: Router,
    private fb: FormBuilder, private _navbarService: navbarService, private _toastr: ToastrService,
  ...
  submitPostSettings() {
    this._navbarService.postSettings(this.settingsFormObj).subscribe(
      data => {
  ...
  postTestUI() {
    ...
    this._navbarService.postTestUI(this.testUI.value).subscribe(
      response => {
        if (response) {
  ...
  testSuites: [];
  getTestSuites() {
    this._navbarService.getTestSuites().subscribe(
      response => {
  ...
  getViews() {
    ...
    this._navbarService.getViews().subscribe(
      data => {
        this.views = data;
  ...
  imagepath: any;
  getImagePaths() {
    this._navbarService.getImagePaths().subscribe(
      data => {
        this.imagepath = data;
      })
  }
  ...
  submitPostBuild() {
    ...
    this.spinnerService.show();
    var build_no;
    this._navbarService.postBuild(this.buildFormObj).subscribe(
      data => {
        build_no = data;
        this.spinnerService.hide();
